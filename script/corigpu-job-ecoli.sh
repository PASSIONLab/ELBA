...
srun -n 16 /global/cscratch1/sd/gguidi/diBELLA.2D/build_release/./elba -i /global/cscratch1/sd/gguidi/diBELLA.2D/ecoli_hifi_29x.fasta -k 31 --idxmap ecoli.hifi.29x.idxmap -c 17210 --alph dna --af ecoli.hifi.29x.result -s 1 -O 100000 --afreq 100000 --xa 15
