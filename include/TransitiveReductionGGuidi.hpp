...
void TransitiveReductionOld(PSpMat<ReadOverlap>::MPI_DCCols& B, TraceUtils tu)
{
    ...
    uint nnz, prev;
    // uint check_phase_counter = 0;  // GGGG: I don't fully understand this
    // uint full_counter = 0;         // GGGG: I don't fully understand this

    uint count = 0;     // GGGG: I don't fully understand this
    uint countidle = 0; // GGGG: I don't fully understand this
    ...
    do
    {
        ...
        /* GGGG: you don't need a copy for T, it can be done in place */
